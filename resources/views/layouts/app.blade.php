		...
		<div id="wrapper" class="container">
									...
									<div class="carousel-inner">
										<div class="active item">
											<ul class="thumbnails">												
												...
												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/2.jpg') !!}" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/3.jpg') !!}" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/4.jpg') !!}" alt="" /></a></p>
										...
										<div class="item">
											<ul class="thumbnails">
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/5.jpg') !!}" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/6.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">Ut wisi enim ad</a><br/>
														<a href="products.html" class="category">Commodo consequat</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/7.jpg') !!}" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/ladies/8.jpg') !!}" alt="" /></a></p>
									...
									<div class="carousel-inner">
										<div class="active item">
											<ul class="thumbnails">												
												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/cloth/bootstrap-women-ware2.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">Ut wisi enim ad</a><br/>
														<a href="products.html" class="category">Commodo consequat</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/cloth/bootstrap-women-ware1.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">Quis nostrud exerci tation</a><br/>
														<a href="products.html" class="category">Quis nostrud</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/cloth/bootstrap-women-ware6.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">Know exactly turned</a><br/>
														<a href="products.html" class="category">Quis nostrud</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/cloth/bootstrap-women-ware5.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">You think fast</a><br/>
														<a href="products.html" class="category">World once</a>
										...
										<div class="item">
											<ul class="thumbnails">
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/cloth/bootstrap-women-ware4.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">Know exactly</a><br/>
														<a href="products.html" class="category">Quis nostrud</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.html"><img src="{!! asset('public/themes/images/cloth/bootstrap-women-ware3.jpg') !!}" alt="" /></a></p>
														<a href="product_detail.html" class="title">Ut wisi enim ad</a><br/>
														<a href="products.html" class="category">Commodo consequat</a>
			...
			<section id="footer-bar">
				<div class="row">
					...
					<div class="span5">
						<p class="logo"><img src="{!! asset('public/themes/images/logo.png') !!}" class="site_logo" alt=""></p>
